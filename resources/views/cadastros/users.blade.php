...
@endphp
    <div class="card border">
        <div class="card-body">
            ...
            <a type="button" class="float-button" data-bs-toggle="modal" data-bs-target="#exampleModal" data-toggle="tooltip" data-placement="bottom" title="Adicionar Novo(a) useristrador(a)">
            ...
            <table class="table table-striped table-ordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="badge bg-warning" data-bs-toggle="modal" data-bs-target="#exampleModal{{$user->id}}" data-toggle="tooltip" data-placement="left" title="Editar">
                            ...
                            <div class="modal fade" id="exampleModal{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="card-body">
                                            <form method="POST" action="/cadastros/user/editar/{{$user->id}}">
                                                @csrf
                            ...
                            @if($user->ativo==1)
                                <a href="/cadastros/user/ativar/{{$user->id}}" class="badge bg-dark" data-toggle="tooltip" data-placement="right" title="Inativar"><i class="material-icons md-18 red">disabled_by_default</i></a>
                            @else
                                <a href="/cadastros/user/ativar/{{$user->id}}" class="badge bg-dark" data-toggle="tooltip" data-placement="right" title="Ativar"><i class="material-icons md-18 green">check_box</i></a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <form method="POST" action="/cadastros/user">
                        @csrf
                        <div class="col-12 form-floating">
